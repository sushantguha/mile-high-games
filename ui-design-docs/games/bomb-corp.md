...
> Game ID: `bomb-corp` · Archetype: `teamwork` · Pack: Jackbox Party Pack 2
> **Inspiration (not a copy):** Bomb Corp — office bomb squad red
...
### Prompt
- Phase label in accent color; Greg emoji wiggles
