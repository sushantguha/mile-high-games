...
> Game ID: `fixy-text` · Archetype: `text-transform` · Pack: Jackbox Party Pack 10
> **Inspiration (not a copy):** FixyText — glitch machines, ASCII faces
...
### Prompt
- Phase label in accent color; Glitch emoji wiggles
