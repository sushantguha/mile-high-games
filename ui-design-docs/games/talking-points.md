# Talking Points — UI Design

> Game ID: `talking-points` · Archetype: `debate` · Pack: Jackbox Party Pack 7
> **Inspiration (not a copy):** Talking Points — news desk teal
...
### Prompt
- Phase label in accent color; Anchor emoji wiggles
- Prompt slides up inside `prompt-card` with glow border
- **Sound:** `prompt` chime (host only)

### Input
- Talking heads frame; argument cards slide
