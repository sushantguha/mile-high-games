# Drawful Animate — UI Design

> Game ID: `drawful-animate` · Archetype: `Draw, guess, then animate!` · Pack: Jackbox Party Pack 8
> **Inspiration (not a copy):** Drawful Animate — purple sketch + motion
