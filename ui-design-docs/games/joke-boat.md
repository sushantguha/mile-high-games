...
> Game ID: `joke-boat` · Archetype: `write-vote` · Pack: Jackbox Party Pack 6
> **Inspiration (not a copy):** Joke Boat — nautical comedy blue
...
### Prompt
- Phase label in accent color; Captain emoji wiggles
