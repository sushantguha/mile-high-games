...
> Game ID: `roomerang` · Archetype: `write-vote` · Pack: Jackbox Party Pack 9
> **Inspiration (not a copy):** Roomerang — boomerang variety show
...
### Prompt
- Phase label in accent color; Boomerang emoji wiggles
