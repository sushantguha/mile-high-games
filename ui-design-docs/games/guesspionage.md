# Guesspionage — UI Design

> Game ID: `guesspionage` · Archetype: `write-vote` · Pack: Jackbox Party Pack 3
> **Inspiration (not a copy):** Guesspionage — spy dossier, cyan intel
...
### Prompt
- Phase label in accent color; Foxy emoji wiggles
