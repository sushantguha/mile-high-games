# Dictionarium — UI Design

> Game ID: `dictionarium` · Archetype: `write-vote` · Pack: Jackbox Party Pack 6
> **Inspiration (not a copy):** Dictionarium — dictionary orange
...
### Prompt
- Phase label in accent color; Lexicon emoji wiggles
