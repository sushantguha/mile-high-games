# Cookie Haus — UI Design

> Game ID: `cookie-haus` · Archetype: `draw-guess` · Pack: Jackbox Party Pack 11
> **Inspiration (not a copy):** Cookie Haus — warm bakery, cookie characters
