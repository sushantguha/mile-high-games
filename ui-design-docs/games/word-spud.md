...
> Game ID: `word-spud` · Archetype: `Chain words with secret rules.` · Pack: Jackbox Party Pack 1
> **Inspiration (not a copy):** Word Spud — potato word chain orange
...
### Prompt
- Phase label in accent color; Word Spud emoji wiggles
