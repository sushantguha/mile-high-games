# The Devils and the Details — UI Design

> Game ID: `the-devils-and-the-details` · Archetype: `teamwork` · Pack: Jackbox Party Pack 7
> **Inspiration (not a copy):** Devils and Details — hell kitchen teamwork
...
### Prompt
- Phase label in accent color; Devils emoji wiggles
- Prompt slides up inside `prompt-card` with glow border
- **Sound:** `prompt` chime (host only)

### Input
- Role cards deal out to player slots
...
### Input
- Large option buttons or role-reveal card with accent border
