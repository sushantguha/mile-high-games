# Hypnotorious — UI Design

> Game ID: `hypnotorious` · Archetype: `write-vote` · Pack: Jackbox Party Pack 10
> **Inspiration (not a copy):** Hypnotorious — spiral hypnosis, purple haze
...
### Prompt
- Phase label in accent color; Hypnotist emoji wiggles
