# Split the Room — UI Design

> Game ID: `split-the-room` · Archetype: `rank` · Pack: Jackbox Party Pack 5
> **Inspiration (not a copy):** Split the Room — owl host, balanced scale
...
|-------|-------|
| Accent | #eab308 |
| Pattern | `game-pattern-split` |
| Mood | Opinion split — scale or ladder visual |
| Icons | 🦉⚖️ |
| Host persona | Mayonnaise 🦉 |
...
### Prompt
- Phase label in accent color; Mayonnaise emoji wiggles
