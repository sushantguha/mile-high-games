# Role Models — UI Design

> Game ID: `role-models` · Archetype: `role-label` · Pack: Jackbox Party Pack 6
> **Inspiration (not a copy):** Role Models — party stickers pink
