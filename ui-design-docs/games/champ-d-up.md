# Champ'd Up — UI Design

> Game ID: `champ-d-up` · Archetype: `draw-guess` · Pack: Jackbox Party Pack 7
> **Inspiration (not a copy):** Champ'd Up — superhero roster pink
...
### Prompt
- Phase label in accent color; Champ emoji wiggles
