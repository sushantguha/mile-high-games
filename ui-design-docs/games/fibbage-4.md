...
> Game ID: `fibbage-4` · Archetype: `Bluff the real answer.` · Pack: Jackbox Party Pack 9
> **Inspiration (not a copy):** Fibbage theater — Cookie, blue stage, spotlights
...
|-------|-------|
| Accent | #3b82f6 |
| Pattern | `game-pattern-fibbage` |
| Mood | Comedy club — mic spotlight, orange/warm quip energy |
| Icons | 🎭🃏 |
| Host persona | Cookie Masterson 🎭 |
...
### Prompt
- Phase label in accent color; Cookie Masterson emoji wiggles
