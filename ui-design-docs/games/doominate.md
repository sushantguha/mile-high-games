...
> Game ID: `doominate` · Archetype: `write-vote` · Pack: Jackbox Party Pack 11
> **Inspiration (not a copy):** Doominate — medieval throne, red crown
...
### Prompt
- Phase label in accent color; Overlord emoji wiggles
