# Fakin' It All Night Long — UI Design

> Game ID: `fakin-it-all-night-long` · Archetype: `hidden-task` · Pack: The Jackbox Naughty Pack
> **Inspiration (not a copy):** Naughty Fakin It — moonlit carnival
...
### Prompt
- Phase label in accent color; Cookie emoji wiggles
