...
> Game ID: `bidiots` · Archetype: `write-vote` · Pack: Jackbox Party Pack 2
> **Inspiration (not a copy):** Bidiots — art auction green
...
### Prompt
- Phase label in accent color; Art Dealer emoji wiggles
