...
> Game ID: `job-job` · Archetype: `write-vote` · Pack: Jackbox Party Pack 8
> **Inspiration (not a copy):** Job Job — corporate HR gray-blue
...
### Prompt
- Phase label in accent color; HR emoji wiggles
