# Civic Doodle — UI Design

> Game ID: `civic-doodle` · Archetype: `draw-guess` · Pack: Jackbox Party Pack 4
> **Inspiration (not a copy):** Civic Doodle — mayor town hall purple
...
### Prompt
- Phase label in accent color; Mayor emoji wiggles
