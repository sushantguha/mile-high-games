# Nonsensory — UI Design

> Game ID: `nonsensory` · Archetype: `write-vote` · Pack: Jackbox Party Pack 9
> **Inspiration (not a copy):** Nonsensory — sensory overload purple
...
### Prompt
- Phase label in accent color; Sense Host emoji wiggles
