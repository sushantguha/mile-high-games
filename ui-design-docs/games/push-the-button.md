# Push the Button — UI Design

> Game ID: `push-the-button` · Archetype: `hidden-task` · Pack: Jackbox Party Pack 6
> **Inspiration (not a copy):** Push the Button — spaceship sci-fi red alert
...
### Prompt
- Phase label in accent color; Ship AI emoji wiggles
