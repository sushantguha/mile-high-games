...
> Game ID: `quixort` · Archetype: `write-vote` · Pack: Jackbox Party Pack 9
> **Inspiration (not a copy):** Quixort — library sorting, indigo shelves
...
### Prompt
- Phase label in accent color; Librarian emoji wiggles
