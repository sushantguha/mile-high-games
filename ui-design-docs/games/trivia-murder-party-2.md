# Trivia Murder Party 2 — UI Design

> Game ID: `trivia-murder-party-2` · Archetype: `Trivia or die — ghosts can still win!` · Pack: Jackbox Party Pack 6
> **Inspiration (not a copy):** TMP2 — Death host, blood red, haunted mansion
...
### Prompt
- Phase label in accent color; Death emoji wiggles
