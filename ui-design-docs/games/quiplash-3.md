# Quiplash 3 — UI Design

> Game ID: `quiplash-3` · Archetype: `Write funny answers, vote for the best.` · Pack: Jackbox Party Pack 7
> **Inspiration (not a copy):** Quiplash — orange quip bubbles, Schmitty energy
...
### Prompt
- Phase label in accent color; Schmitty emoji wiggles
