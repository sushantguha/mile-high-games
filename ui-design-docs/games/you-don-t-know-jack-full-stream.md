# You Don't Know Jack Full Stream — UI Design

> Game ID: `you-don-t-know-jack-full-stream` · Archetype: `trivia` · Pack: Jackbox Party Pack 5
> **Inspiration (not a copy):** YDKJ — trivia indigo, Buzz! energy
...
### Prompt
- Phase label in accent color; Buzz emoji wiggles
