# Legends of Trivia — UI Design

> Game ID: `legends-of-trivia` · Archetype: `trivia` · Pack: Jackbox Party Pack 11
> **Inspiration (not a copy):** Legends of Trivia — game show gold
...
### Prompt
- Phase label in accent color; Legend emoji wiggles
