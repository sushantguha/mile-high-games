...
> Game ID: `time-jinx` · Archetype: `trivia` · Pack: Jackbox Party Pack 10
> **Inspiration (not a copy):** Timejinx — retro science lab, UPA blocky style
...
### Prompt
- Phase label in accent color; Jerri Rig emoji wiggles
