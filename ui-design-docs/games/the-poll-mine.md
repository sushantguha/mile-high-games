# The Poll Mine — UI Design

> Game ID: `the-poll-mine` · Archetype: `rank` · Pack: Jackbox Party Pack 8
> **Inspiration (not a copy):** Poll Mine — mine shaft brown
...
|-------|-------|
| Accent | #78716c |
| Pattern | `game-pattern-mine` |
| Mood | Opinion split — scale or ladder visual |
| Icons | ⛏️🪨 |
| Host persona | Foreman ⛏️ |
...
### Prompt
- Phase label in accent color; Foreman emoji wiggles
- Prompt slides up inside `prompt-card` with glow border
- **Sound:** `prompt` chime (host only)

### Input
- Spectrum bar fills as votes land
...
### Input
- Ordered list input or drag-ranked items
