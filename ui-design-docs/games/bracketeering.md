# Bracketeering — UI Design

> Game ID: `bracketeering` · Archetype: `write-vote` · Pack: Jackbox Party Pack 4
> **Inspiration (not a copy):** Bracketeering — tournament gold
...
### Prompt
- Phase label in accent color; Bobbin emoji wiggles
