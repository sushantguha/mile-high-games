...
> Game ID: `junktopia` · Archetype: `write-vote` · Pack: Jackbox Party Pack 9
> **Inspiration (not a copy):** Junktopia — trash heap kingdom, lime green
...
### Prompt
- Phase label in accent color; Junk Lord emoji wiggles
