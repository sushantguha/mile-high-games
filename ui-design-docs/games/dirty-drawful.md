# Dirty Drawful — UI Design

> Game ID: `dirty-drawful` · Archetype: `draw-guess` · Pack: The Jackbox Naughty Pack
> **Inspiration (not a copy):** Naughty Drawful — pink neon, sketch pad
...
### Prompt
- Phase label in accent color; Drawful emoji wiggles
