# Mad Verse City — UI Design

> Game ID: `mad-verse-city` · Archetype: `write-vote` · Pack: Jackbox Party Pack 5
> **Inspiration (not a copy):** Mad Verse City — rap battle neon city
...
### Prompt
- Phase label in accent color; MC emoji wiggles
