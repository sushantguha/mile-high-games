# Zeeple Dome — UI Design

> Game ID: `zeeple-dome` · Archetype: `teamwork` · Pack: Jackbox Party Pack 5
> **Inspiration (not a copy):** Zeeple Dome — alien arena green
...
### Prompt
- Phase label in accent color; Zeeps emoji wiggles
