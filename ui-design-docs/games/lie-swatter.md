# Lie Swatter — UI Design

> Game ID: `lie-swatter` · Archetype: `Swat the lies, avoid the truths!` · Pack: Jackbox Party Pack 1
> **Inspiration (not a copy):** Jackbox Lie Swatter — flies carry facts, neon green swamp
...
### Prompt
- Phase label in accent color; Fly Guy emoji wiggles
