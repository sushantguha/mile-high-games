# Patently Stupid — UI Design

> Game ID: `patently-stupid` · Archetype: `draw-guess` · Pack: Jackbox Party Pack 5
> **Inspiration (not a copy):** Patently Stupid — patent office cyan
...
|-------|-------|
| Accent | #22d3ee |
| Pattern | `game-pattern-patent` |
| Mood | Sketch pad energy — white canvas, colorful chrome |
| Icons | 💡📋 |
| Host persona | Patent Office 💡 |
...
### Prompt
- Phase label in accent color; Patent Office emoji wiggles
